...
<html lang="en">
	<head>
		...
		<title>Terms &amp; Conditions - International Christian Academy</title>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-10 offset-md-2 main animated fadeIn" style="animation-duration: 500ms;">
					<h3><span><i class="fa fa-list"></i></span> Terms &amp; Conditions</h3>
					<a href="<?php echo base_url('Admin/terms?page_status=EDIT');?>" class="btn btn-primary btn-sm"><span><i class="fas fa-pencil-alt"></i></span> Edit</a>
