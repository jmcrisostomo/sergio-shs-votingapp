<div class="col-md-2 sidebar animated " style="animation-duration: 0.4s;" id="sidebar">
		<ul class="nav flex-column">
			<li>
				<div class="user-content">
					...
					<p class="text-center"><strong>JM Crisostomo
							<?php
 ...
 <!-- <div class="col-md-2 sidebar animated " style="animation-duration: 0.4s;" id="sidebar">
		<ul class="nav flex-column">
			...
			<li class="nav-item">
				<!- - <a class="nav-link animated fadeInLeft" style="animation-duration: 500ms;" href="<?php echo base_url();?>" id="sidebarHome"><span><i class="fa fa-fw fa-home"></i></span> Home</a> - ->
				<a class="nav-link animated fadeInLeft" style="animation-duration: 500ms;" href="<?php echo base_url();?>" id="sidebarHome">
					<div class="sidebar-tabs text-center">
						<span><i class="fa fa-2x fa-home"></i></span>
						<p>Home</p>
					</div>
				</a>
